...
function openBoughtGame(title) {
  ...
  const gameDescription =
    '<textarea class="scrollabletextbox" name="description" readonly>' +
    'Description:\n\n' +
  ...
  if (currentGame.isPinned) {
    pinned = '<i class="fa-solid fa-map-pin"></i></button></div>';
  } else {
    pinned = '<i class="fa-solid fa-map-pin unpinned"></i></button></div>';
  }
